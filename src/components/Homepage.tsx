        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto space-y-8 mb-16 p-4 sm:p-8 rounded-3xl backdrop-blur-sm">
            ...
            <p className="text-base sm:text-lg text-neutral-medium max-w-2xl leading-relaxed">
              {siteConfig?.heroSubtitle ? siteConfig.heroSubtitle : 'Luminary is a premium engineering academy designed for programmers, structural architects, and Web3 executives. Join certified developers locking in lifetime lifepasses.'}
            </p>
      ...
      <section className="py-20 md:py-28 bg-neutral-bg" id="catalog-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 text-center max-w-xl mx-auto space-y-4">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-neutral-dark tracking-tight mt-3">{siteConfig?.catalogTitle || 'Premium Learning Pathways'}</h2>
          </div>
        </div>
